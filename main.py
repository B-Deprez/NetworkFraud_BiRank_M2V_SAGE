...
def run_model(fraud_node_tf):
    ...
    # Calculate all resutls for BiRank and generate figures
    pred_meta, fpr_meta, tpr_meta, res_meta = excecute.Metapath2Vec_subroutine(HG, labels, fraud_node_tf=fraud_node_tf)
    ...
    simple_network_features = simple_network_feature_engineering(HG)
